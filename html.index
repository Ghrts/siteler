...
@app.route("/")
def hello_world():
    return '<h1>Hello, World!</h1> <a href="/facts">Rastgele bir gerçeği görüntüle!</a>, <a href="/efe">Efe hakkında rastgele bir gerçeği görüntüle!</a>'
...
efe_list = [
    "Efe'nin Kaplumbağası vardır",
    "Efe'nin En sevdiği rakam 9",
    "Efe'nin memleketi Amasya",
    "Efe'nin en son oynadığı oyun BODYCAM",
    "Efe 11. Sınıfa geçiyor",
    "Efe 16 yaşında",
    "Efe'nin en sevdiği yemek tavuklu pilav",
    "Efe'nin hayalindeki meslek SAVAŞ PİLOTLUĞU"
]

@app.route("/efe")
def efe():
    return f'<p>{random.choice(efe_list)}</p>'
